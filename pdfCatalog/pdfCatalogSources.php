...
if($offers){
    ...
    foreach ($offers as $offer) {
        ...
        if($offer->publics){
            ...
            $content_publics = '<div class="content">'.str_replace(',',', ',$offer->publics).'</div>';
    ...
    <head>
        ...
        <style>
            @font-face {
                  ...
                  src: url("'.$PAGE->theme->font_url('fa-solid-900-cat.ttf', 'local_magistere_offers')->out().'") format("truetype");
}
        </style>
